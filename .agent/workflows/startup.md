...
3. **Branching**: Checkout a new feature branch (pattern: `[initials]/[feature-name]`) before writing any code, or return to an active feature branch and rebase/merge `main`. Never write code on `main`.
